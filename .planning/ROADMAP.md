...
- [x] 04-05-PLAN.md — docs/anti-piracy.md + human verification checkpoint
...
- [x] 05-05-PLAN.md — 5 Server Actions (upsert/attach/promote/demote/detach/search) + tests; promote/demote via RPC
...
| 5. B2B Institution Manager | 7/9 | In Progress|  |
