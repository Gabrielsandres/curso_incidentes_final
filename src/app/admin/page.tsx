      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-6 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Este espaco esta protegido por role. Apenas usuarios com perfil <strong>admin</strong> passam do middleware e
            desta checagem no servidor. Construa funcionalidades administrativas aqui com seguranca adicional.
          </p>
        </div>
      </main>
    </div>
